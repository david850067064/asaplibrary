package ui.accordion {
	...
	public class Pane extends FlowSection implements IPaneContent {
		...
		*/
		...
		public function setState (inState:uint, inMovingPane:Pane = null) : void {
			mState = inState;
		}
		...
		public override function get startAction () : IAction {
			mMoveQueue.addAction(mDelegate, mDelegate.select, true);
			...
			mMoveQueue.addAction(this, setState, PaneOptions.OPEN);
			return mMoveQueue;
		}
		...
		protected function initBehavior () : void {
			...
			mDelegate.addEventListener(ButtonBehaviorDelegateEvent._EVENT, updateBarStatus);
		}
		...
		*/
		protected function updateBarStatus (e:ButtonBehaviorDelegateEvent) : void {
