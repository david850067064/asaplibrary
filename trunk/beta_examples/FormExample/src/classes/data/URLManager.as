package data {
	...
	public class URLManager extends Service {
		...
		public function URLManager () {if (theInstance) throw new Error("Singleton, use OneStat.getInstance()");}
		public static function getInstance () : URLManager {return theInstance;}
