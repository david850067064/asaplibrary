package controller {
	...
	public class Observer extends LocalController {
		...
		const RECEIVER_DEFAULT_TEXT = "";
		const RECEIVER_RECEIVING_TEXT = "Observing\n...";
		
		function Observer() {
			NotificationCenter.getDefaultCenter().setCheckOnAdding(true); // prevent us from adding more and more listeners for the same notification name. But this is hypothetical for now because we will disable the add button once clicked, to provide a better user interface.
