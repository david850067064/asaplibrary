package demo.ThumbController.controller {
	import demo.ThumbController.ui.ImagePlaceholder;
	import demo.ThumbController.ui.NextButton;
	import demo.ThumbController.ui.ThumbImage;
	...
	public class ThumbController extends MovieClip {
		 ...
		 */
		private function activateThumb(inThumb : ThumbImage, inOldThumb : ThumbImage = null) : void {
			if (inOldThumb) {
		...
		private function handleThumbClick(e : MouseEvent) : void {
			...
			mThumbPager.setCurrentObject(thumb);
			// will update the enumerator
