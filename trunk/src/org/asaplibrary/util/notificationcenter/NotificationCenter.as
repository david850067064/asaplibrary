...
package org.asaplibrary.util.notificationcenter {
	...
	<code>
	NotificationCenter.getDefaultCenter().post("AdviceAccordionDidUpdateNotification", null, prodData);
	</code>
	...
	public class NotificationCenter {
		...
		private var mTempCleanupList : Array;
		/**< Marked observerData objects to be removed */
		private var mCheckOnAdding : Boolean;
		/**< Check for doubles flag */
		private var mNotifyErrors : Boolean;

		/**< Will report errrors flag */
		/**
		...
		public function NotificationCenter(inShouldNotifyErrors : Boolean = false) {
			...
			setNotifyErrors(inShouldNotifyErrors);
		}
		...
		public function getNotifyErrors() : Boolean {
			return mNotifyErrors;
		}
		 ...
		 */
		public function setCheckOnAdding(inFlag : Boolean) : void {
			mCheckOnAdding = inFlag;
		}

		public function getCheckOnAdding() : Boolean {
			return mCheckOnAdding;
		}
		...
		<code>
		NotificationCenter.getDefaultCenter().addObserver(this, "updatePanel", null, myPanel);
		</code>
		 ...
		 */
		public function removeObserver(inObserver : Object, inNotificationName : String = "", inNotificationObject : Object = null) : void {
			inNotificationName ||= DEFAULT_NOTIFICATION_NAME;
		 ...
		 */
		public function post(inNotificationName : String = "", inNotificationObject : Object = null, inData : Object = null) : void {
			inNotificationName ||= DEFAULT_NOTIFICATION_NAME;
			...
			while (--i != -1) {
				...
				/*
				if (inNotificationName != observerData.note) {
		 ...
		 */
		private function removeFromCollection(inCollection : Object, inObserver : Object, inNotificationName : String, inNotificationObject : Object) : Boolean {
