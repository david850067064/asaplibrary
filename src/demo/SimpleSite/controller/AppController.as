package demo.SimpleSite.controller {
	...
	public class AppController extends MovieClip {
		...
		protected function loadNewMovie(inMovieName : String) : void {
			switch (inMovieName) {
				case AppSettings.HOME_NAME:
					MovieManager.getInstance().loadMovie(AppSettings.HOME_URL, AppSettings.HOME_NAME);
					break;
				case AppSettings.GALLERY_NAME:
					MovieManager.getInstance().loadMovie(AppSettings.GALLERY_URL, AppSettings.GALLERY_NAME);
					break;
				case AppSettings.MENU_NAME:
					MovieManager.getInstance().loadMovie(AppSettings.MENU_URL, AppSettings.MENU_NAME);
					break;
				default:
					break;
			}
