	...
	*/
	public class ConditionTestCase extends TestCase {
		...
		public function testConstructor () : void {
			var condition:Condition = new Condition(this, evaluateTestTrue);
			assertTrue("ConditionTestCase testConstructor", condition);
		}
		
		public function testRun () : void {
			var condition1:Condition = new Condition(this, evaluateTest2, [-1]);
			var result1:Boolean = condition1.run();
			assertFalse("ConditionTestCase testRun 1", result1);
			
			var condition2:Condition = new Condition(this, evaluateTest2, [1]);
			var result2:Boolean = condition2.run();
			assertTrue("ConditionTestCase testRun 2", result2);
			
			var condition3:Condition = new Condition(this, evaluateTestTrue);
			condition3.run();
			assertTrue("ConditionTestCase testRun 3", condition3.isMet());
			
			var condition4:Condition = new Condition(this, evaluateTestFalse);
			condition4.run();
			assertFalse("ConditionTestCase testRun 4", condition4.isMet());
		}
		
		public function testConditionMetCallFunctions () : void {
			var condition:Condition = new Condition(this, evaluateTestTrue, null, [conditionMetCallFunction]);
			condition.run();
		...
		public function testConditionNotMetCallFunctions () : void {
			var condition:Condition = new Condition(this, evaluateTestFalse, null, null, [conditionNotMetCallFunction]);
			condition.run();
